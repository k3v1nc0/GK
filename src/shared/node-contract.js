...
export const VALIDATION_CODES = Object.freeze({
  ...
  ,
  CATALOG_DEFINITION_DUPLICATE: "CATALOG_DEFINITION_DUPLICATE",
  CATALOG_REFERENCE_MISSING: "CATALOG_REFERENCE_MISSING",
  CATALOG_REFERENCE_WRONG_KIND: "CATALOG_REFERENCE_WRONG_KIND",
  CATALOG_DEPENDENCY_CYCLE: "CATALOG_DEPENDENCY_CYCLE",
  ITEM_STACK_RULE_INVALID: "ITEM_STACK_RULE_INVALID",
  ITEM_EQUIPMENT_SLOT_MISSING: "ITEM_EQUIPMENT_SLOT_MISSING",
  ITEM_TRADE_POLICY_CONFLICT: "ITEM_TRADE_POLICY_CONFLICT",
  CURRENCY_PRECISION_INVALID: "CURRENCY_PRECISION_INVALID",
  STAT_RANGE_INVALID: "STAT_RANGE_INVALID",
  STAT_BLOCK_DUPLICATE_STAT: "STAT_BLOCK_DUPLICATE_STAT",
  CURVE_POINTS_INVALID: "CURVE_POINTS_INVALID",
  ANIMATION_CLIP_MISSING: "ANIMATION_CLIP_MISSING",
  ABILITY_FORMULA_INVALID: "ABILITY_FORMULA_INVALID",
  ABILITY_TARGET_RULE_INVALID: "ABILITY_TARGET_RULE_INVALID",
  STATUS_EFFECT_INVALID: "STATUS_EFFECT_INVALID",
  ENEMY_ARCHETYPE_INCOMPLETE: "ENEMY_ARCHETYPE_INCOMPLETE",
  VARIANT_BASE_MISSING: "VARIANT_BASE_MISSING",
  AI_PROFILE_INTERVAL_UNSAFE: "AI_PROFILE_INTERVAL_UNSAFE",
  LOOT_TABLE_EMPTY: "LOOT_TABLE_EMPTY",
  LOOT_TABLE_CYCLE: "LOOT_TABLE_CYCLE",
  LOOT_ENTRY_RANGE_INVALID: "LOOT_ENTRY_RANGE_INVALID",
  RESOURCE_DEFINITION_INCOMPLETE: "RESOURCE_DEFINITION_INCOMPLETE",
  SPAWN_ENEMY_REF_MISSING: "SPAWN_ENEMY_REF_MISSING",
  SPAWN_AREA_INVALID: "SPAWN_AREA_INVALID",
  SPAWN_MAX_ALIVE_INVALID: "SPAWN_MAX_ALIVE_INVALID",
  SPAWN_CONTROLLER_BUDGET_INVALID: "SPAWN_CONTROLLER_BUDGET_INVALID",
  ENTITY_COMBAT_COMPONENT_CONFLICT: "ENTITY_COMBAT_COMPONENT_CONFLICT",
  PLAYER_CHARACTER_DEFINITION_MISSING: "PLAYER_CHARACTER_DEFINITION_MISSING",
  PLAYER_RULES_MISSING: "PLAYER_RULES_MISSING",
  PLAYER_STAT_MAPPING_MISSING: "PLAYER_STAT_MAPPING_MISSING",
  PLAYER_INVENTORY_POLICY_MISSING: "PLAYER_INVENTORY_POLICY_MISSING",
  PLAYER_ABILITY_POLICY_MISSING: "PLAYER_ABILITY_POLICY_MISSING",
  ZONE_GROUP_INVALID: "ZONE_GROUP_INVALID",
  ZONE_DEFINITION_MISSING: "ZONE_DEFINITION_MISSING",
  ZONE_DEFINITION_DUPLICATE: "ZONE_DEFINITION_DUPLICATE",
  ZONE_BOUNDS_INVALID: "ZONE_BOUNDS_INVALID",
  ZONE_DEFAULT_SPAWN_MISSING: "ZONE_DEFAULT_SPAWN_MISSING",
  ZONE_DEFAULT_SPAWN_DUPLICATE: "ZONE_DEFAULT_SPAWN_DUPLICATE",
  ZONE_SPAWN_OUT_OF_BOUNDS: "ZONE_SPAWN_OUT_OF_BOUNDS",
  ZONE_LINK_TARGET_INVALID: "ZONE_LINK_TARGET_INVALID",
  AREA_GROUP_INVALID: "AREA_GROUP_INVALID",
  MINIMAP_ZONE_BAKE_MISSING: "MINIMAP_ZONE_BAKE_MISSING"
});
