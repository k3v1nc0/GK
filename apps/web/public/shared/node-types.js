...
const GAME_MINIMAP_MARKER_CATEGORY_DEFAULTS = [
  { id: "character", label: "Character/User", source: "character", enabled: true, color: "#ffe08a", shape: "triangle", iconAssetId: null, showLabel: true, clampOutside: true, showThroughFog: true, fixedSizeOnZoom: false, iconSizePx: 9, fontSizePx: 10, nameMaxLength: 14, animation: "none" },
  { id: "users", label: "Users", source: "users", enabled: true, color: "#ffe08a", shape: "triangle", iconAssetId: null, showLabel: true, clampOutside: true, showThroughFog: true, fixedSizeOnZoom: false, iconSizePx: 9, fontSizePx: 10, nameMaxLength: 14, animation: "none" },
  { id: "enemy", label: "Enemy", source: "enemy", enabled: false, color: "#ef4444", shape: "square", iconAssetId: null, showLabel: false, clampOutside: false, showThroughFog: false, fixedSizeOnZoom: false, iconSizePx: 9, fontSizePx: 10, nameMaxLength: 14, animation: "none" },
  { id: "boss", label: "Boss", source: "boss", enabled: false, color: "#f97316", shape: "star", iconAssetId: null, showLabel: true, clampOutside: true, showThroughFog: true, fixedSizeOnZoom: false, iconSizePx: 12, fontSizePx: 10, nameMaxLength: 14, animation: "glow" },
  { id: "wildlife", label: "Wild life", source: "wildlife", enabled: false, color: "#22c55e", shape: "dot", iconAssetId: null, showLabel: false, clampOutside: false, showThroughFog: false, fixedSizeOnZoom: false, iconSizePx: 8, fontSizePx: 10, nameMaxLength: 14, animation: "none" },
  { id: "npc", label: "NPC", source: "npc", enabled: true, color: "#c084fc", shape: "diamond", iconAssetId: null, showLabel: true, clampOutside: false, showThroughFog: false, fixedSizeOnZoom: false, iconSizePx: 9, fontSizePx: 10, nameMaxLength: 14, animation: "none" },
  { id: "quest", label: "Quest", source: "quest", enabled: true, color: "#facc15", shape: "dot", iconAssetId: null, showLabel: true, clampOutside: true, showThroughFog: true, fixedSizeOnZoom: false, iconSizePx: 11, fontSizePx: 10, nameMaxLength: 14, animation: "glow" },
  { id: "spawn", label: "Spawn", source: "spawn", enabled: false, color: "#9be870", shape: "cross", iconAssetId: null, showLabel: false, clampOutside: false, showThroughFog: false, fixedSizeOnZoom: false, iconSizePx: 9, fontSizePx: 10, nameMaxLength: 14, animation: "none" },
  { id: "teleport", label: "Teleport", source: "teleport", enabled: true, color: "#22d3ee", shape: "diamond", iconAssetId: null, showLabel: true, clampOutside: true, showThroughFog: true, fixedSizeOnZoom: false, iconSizePx: 10, fontSizePx: 10, nameMaxLength: 14, animation: "pulse" },
  { id: "settlement", label: "Dorp namen", source: "settlement", enabled: false, color: "#60a5fa", shape: "label", iconAssetId: null, showLabel: true, clampOutside: false, showThroughFog: false, fixedSizeOnZoom: false, iconSizePx: 8, fontSizePx: 11, nameMaxLength: 24, animation: "none" },
  { id: "crafting", label: "Crafting", source: "crafting", enabled: true, color: "#fb923c", shape: "square", iconAssetId: null, showLabel: true, clampOutside: false, showThroughFog: false, fixedSizeOnZoom: false, iconSizePx: 9, fontSizePx: 10, nameMaxLength: 14, animation: "none" },
  { id: "cooking", label: "Cooking", source: "cooking", enabled: false, color: "#f59e0b", shape: "square", iconAssetId: null, showLabel: true, clampOutside: false, showThroughFog: false, fixedSizeOnZoom: false, iconSizePx: 9, fontSizePx: 10, nameMaxLength: 14, animation: "none" },
  { id: "vendor", label: "Vendor", source: "vendor", enabled: true, color: "#a78bfa", shape: "diamond", iconAssetId: null, showLabel: true, clampOutside: false, showThroughFog: false, fixedSizeOnZoom: false, iconSizePx: 9, fontSizePx: 10, nameMaxLength: 14, animation: "none" },
  { id: "market", label: "Market", source: "market", enabled: true, color: "#38bdf8", shape: "diamond", iconAssetId: null, showLabel: true, clampOutside: false, showThroughFog: false, fixedSizeOnZoom: false, iconSizePx: 9, fontSizePx: 10, nameMaxLength: 14, animation: "none" },
  { id: "resource", label: "Resource", source: "resource", enabled: false, color: "#84cc16", shape: "dot", iconAssetId: null, showLabel: false, clampOutside: false, showThroughFog: false, fixedSizeOnZoom: false, iconSizePx: 8, fontSizePx: 10, nameMaxLength: 14, animation: "none" },
  { id: "item", label: "Items", source: "item", enabled: false, color: "#fbbf24", shape: "square", iconAssetId: null, showLabel: false, clampOutside: false, showThroughFog: false, fixedSizeOnZoom: false, iconSizePx: 8, fontSizePx: 10, nameMaxLength: 14, animation: "none" },
  { id: "object", label: "Objects", source: "object", enabled: false, color: "#94a3b8", shape: "dot", iconAssetId: null, showLabel: false, clampOutside: false, showThroughFog: false, fixedSizeOnZoom: false, iconSizePx: 7, fontSizePx: 10, nameMaxLength: 14, animation: "none" }
];
...
export const NODE_TYPES = {
  ...
  model_entity: {
    ...
    fields: {
      entityId: { label: "Entity id", type: "identity", default: "entity.new_entity", required: true, maxLength: 160, pattern: "^[a-z][a-z0-9]*(?:[._:-][a-z0-9]+)*$" },
