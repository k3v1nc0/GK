---
source_path: README/fase17.md
source_commit: 2a9a6077510237e8dfc5c638d0ca996b67a5fa05
source_title: Fase 17 - Complete beginquest met side quest en eindbaas
...
Run asset scan, start alle services, draai content seed alleen als Game Bible compleet is.
...
Werk uit:
Maak node-content seed uit Game Bible en asset/audio/UI registers. Als content ontbreekt, stop. Flow: spawn, NPC, quest accept/share, NPC taak/audio, objective, merchant optioneel, minions, boss gate, boss fight, loot, complete, side quest.
...
Twee spelers spelen complete beginquest en side quest, kopen item, verslaan boss, claimen loot en refreshen.
